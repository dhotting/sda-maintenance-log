...
def generate_pdf():
    try:
                ...
                if logo_buffer:
                    ...
                    company_info = Paragraph('''
                        <para align="right">
                            ...
                            <font size="9" color="#666666">IT & Support Department</font><br/>
        ...
        ref_left = Paragraph(
            ...
            f'<font size="13" color="#003366"><b>#{log_data["id"]}</b></font>'
            f'</para>', 
            styles['Normal']
        )
...
if __name__ == '__main__':
    ...
    try:
        ...
        if "Address already in use" in str(e):
            ...
            print("  -  On Mac/Linux: lsof -ti:5000 | xargs kill -9")
            print("  -  On Windows: netstat -ano | findstr :5000")
            print("\n  Option 2: Use a different port")
            print("  -  Edit this file and change port=5000 to port=5001")
            print("  -  Then update index.html PDF_SERVER_URL to :5001")
            print("\n" + "="*70 + "\n")
        else:
            print(f"\n❌ ERROR: {e}\n")
        sys.exit(1)
